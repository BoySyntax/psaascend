...
const COMPETENCY_LABELS = [
  ...
  { key: "c7",  label: "POLICY INTERPRETATION AND IMPLEMENTATION" },
  { key: "c8",  label: "TRANSACTION PROCESSING" },
  { key: "c9",  label: "ACCOUNTS RECONCILIATION" },
  { key: "c10", label: "PREPARATION AND INTERPRETATION OF FINANCIAL STATEMENTS" },
];
